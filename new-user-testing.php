...
<form name="newtesting" method="post">
                            ...
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your mobile number" pattern="[0-9]{10}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder="Enter NIC Number" required="true">
                                        </div>
                                        <div class="form-group">
                                              <label>Any Govt Issued ID </label>
                                            <input type="text" class="form-control" id="govtidnumber" name="govtidnumber" placeholder="Pancard / Driving License / Voter id / any other" required="true">
                                        </div>
 ...
 <div class="form-group">
                                              <label>City</label>
                                      <input type="text" class="form-control" id="city" name="city" placeholder="Enter your City Here" required="true">
                                        </div>
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Moderna">Moderna</option>    
											 <option value="AstraZeneca">AstraZeneca</option>    
                                                      ...
                                                      <div class="form-group">
                                            <label>Time Slot for Vaccination</label>
							   ...
							   <div class="form-group">
                                              ...
                                              <select class="form-control" id="testtype" name="testtype" required="true">
                                            <option value="">Select</option> 
                                            <option value="Pfizer">Ampara</option>  
                                            <option value="Sinopharm">Anuradhapura</option>
                                            <option value="Moderna">Badulla</option>    
											 <option value="AstraZeneca">Batticaloa</option> 
											 <option value="Pfizer">Colombo</option>  
                                            <option value="Sinopharm">Galle</option>
                                            <option value="Moderna">Gampaha</option>    
											 <option value="AstraZeneca">Hambantota</option> 
											 <option value="Pfizer">Jaffna</option>  
                                            <option value="Sinopharm">Kalutara</option>
                                            <option value="Moderna">Kandy</option>    
											 <option value="AstraZeneca">Kegalle</option> 
											 <option value="Pfizer">Kilinochchi</option>  
                                            <option value="Sinopharm">kurunegala</option>
                                            <option value="Moderna">Mannar</option>    
											 <option value="AstraZeneca">Matale</option> 
											 <option value="Pfizer">Matara</option>  
                                            <option value="Sinopharm">Moneragala</option>
                                            <option value="Moderna">Mullaitivu</option>    
											 <option value="AstraZeneca">Nuwera Eliya</option> 
											 <option value="Pfizer">Polannaruwa</option>  
                                            <option value="Sinopharm">Puttalam</option>
                                            <option value="Moderna">Ratnapura</option>    
											 <option value="AstraZeneca">Trincomalee</option> 
											  <option value="AstraZeneca">Vavuniya</option> 
