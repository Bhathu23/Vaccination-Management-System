...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Vaccination</a>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="form.php">GS Form</a>
          </li>
          
  <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="new-user-testing.php">Booking</a>
          </li>
           <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="live-test-updates.php"></a>
          </li>

           <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="login-user.php">Login</a>
          </li>
   ...
   <section class=" slider_section position-relative">
      ...
      <div class="slider-container">
        ...
        <div class="detail-box">
          ...
          <p>
            Find a location near you, then make an appointment
          </p>
          <div>
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="img/how-to-wear-mask.jpg" alt="" class="slider-img">
              </div>
              <div class="carousel-item">
                <img src="img/policy-page.png" alt="" class="slider-img">
              </div>
              <div class="carousel-item">
                <img src="img/slider-imgg.jpg" alt="" class="slider-img1">
              </div>
            </div>
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
 ...
 <section class="service_section layout_padding" id="prevention">
    <div class="container">
    ...
    <div class="container">
      <div class="service_container layout_padding2">
        <a href="">
          <div class="box">
            <div class="img-box">
              <img src="img/COVWM275.webp" alt="" class="img-1">
              <img src="img/covid.jpg" alt="" class="img-2">
            </div>
            <div class="name">
              <h6>
                Wear masks
        ...
        <a href="">
          <div class="box">
            <div class="img-box">
              <img src="img/sanitizer.webp" alt="" class="img-1">
              <img src="img/covid.jpg" alt="" class="img-2">
            </div>
            <div class="name">
              <h6>
        ...
        <a href="">
          <div class="box">
            <div class="img-box">
              <img src="img/Social_Distancing_.webp" alt="" class="img-1">
              <img src="img/covid.jpg" alt="" class="img-2">
            </div>
            <div class="name">
              <h6>
        ...
        <a href="">
          <div class="box">
            <div class="img-box">
              <img src="img/home.png" alt="" class="img-1">
              <img src="img/covid.jpg" alt="" class="img-2">
            </div>
            <div class="name">
              <h6>
        ...
        <a href="">
          <div class="box">
            <div class="img-box">
              <img src="img/vaccinated.png" alt="" class="img-1">
              <img src="img/covid.jpg" alt="" class="img-2">
            </div>
            <div class="name">
              <h6>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; 3rd Year IT Group-12</p>
    </div>
    <!-- /.container -->
  </footer>
