...
$query="insert into tblmoh(EmpId,FullName,MobileNumber) values('$empid','$fname','$mnumber')";
$result =mysqli_query($con, $query);
if ($result) {
echo '<script>alert("MOH-Officer created successfully.")</script>';
...
<head>
    ...
    <title>Vaccination Management System | Add MOH Officers</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add MOH Officers</h1>
